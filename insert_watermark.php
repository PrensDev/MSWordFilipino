<?php 
	$article_title = "Maglagay ng Watermark";
...
<div class="body">
	<div class="nav_add">
		...
		<span>&rarr;</span>
		<a href="insert_watermark.php" title="Artikulo: Maglagay ng watermark" draggable="false">Maglagay ng watermark</a>
	</div>
	<div class="col">
		<div class="parent_nav">
			...
			<a href="insert_watermark.php" title="Maglagay ng watermark" draggable="false">
				<div class="active_tab">Maglagay ng watermark<br>
					<img src="<?= $IMG_DIR ?>icon.png" height="16px" style="margin-right: 10px">
					<text class="article">Artikulo</text>
				</div>
			</a>
		...
		<div class="page_content">
			<div class="body_head">
				<div class="page_title">Maglagay ng watermark</div>
			</div>

			<div class="info">
				<p>Ang <i>watermark</i> ay isang teksto o larawan, karaniwan na bahagyang malabo ito upang hindi ito sagabal sa pahina. Katulad ng headers at footers, ang <i>watermark</i> ay madalas makita sa lahat ng pahina o dokumento puwera sa takip ng pahina.</p>
			</div>

			<div class="col_info">
				<div class="cont">
					<ol style="1">
						<li>Sa <b>Design</b> tab, piliin ang <B>Watermark</b>.</li>
						<li>Pumili ng <i>pre-configured watermark</i>, katulad ng DRAFT o CONFIDENTIAL.</li>
					</ol>
					<p>Kung sakali na gamitin ang sariling teksto o larawan, gawin ito:</p>
					<ol style="1">
						<li>Sa <b>Design</b> tab, piliin ang <B>Watermark</b>.</li>
						<li>Piliin ang <b>Custom Watermark</b>, sunod ay piliin ang <b>Picture Watermark</b>, tapos pumili ng larawan. Kung teksto naman ang nais na ilagay, piliin ang <b>Text Watermark</b> at ilagay ang nais na teksto sa <b>Text box</b>.</li>
					</ol>
				</div>
			</div>
			...
			<div class="next_article">
				<text>Susunod na artikulo:<br><a href="show_ruler.php" title="Maglabas o magtago ng ruler" draggable="false">Maglabas o magtago ng ruler &rarr;</a></text>
			</div>
